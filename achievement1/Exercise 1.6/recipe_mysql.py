...
def update_recipe(conn, cursor):
    ...
    recipe_id_for_update = int(
        (input("\nPlease enter ID of the recipe you want to update: ")))
    column_for_update = str(input(
        "\nPlease enter the column you want to update (name, ingredients, or cooking_time): "))
...
print("Thank you for using the recipe database")